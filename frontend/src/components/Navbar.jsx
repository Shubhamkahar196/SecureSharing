...
const Navbar = () => {
  ...
  // ✅ Memoized email (avoid recalculation every render)
  ...
  return (
    <nav className="navbar sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-white/20 shadow-lg">
      <div className="nav-container max-w-6xl mx-auto px-6 flex justify-between items-center py-4">
        ...
        <Link
          to="/"
          className="nav-logo text-2xl font-bold bg-gradient-to-r from-primary-500 to-purple-600 bg-clip-text text-transparent hover:scale-105 transition-transform"
        >
          SecureSharing
        </Link>
        ...
        <div className="nav-links flex items-center gap-4">
          ...
          {isAuthenticated ? (
            <>
              <Link
                to="/dashboard"
                className="nav-link px-4 py-2 rounded-lg hover:bg-gradient-to-r hover:from-primary-500 hover:to-purple-600 hover:text-white transition-all duration-300 hover:-translate-y-0.5"
              >
                Dashboard
              </Link>

              <span
                className="nav-user px-3 py-1 bg-primary-50 border border-primary-200 rounded-full text-sm text-primary-700"
                title={user?.email}
              >
                {shortEmail}
              </span>
              ...
              <button
                ...
                className="nav-button bg-gradient-to-r from-pink-500 to-red-500 text-white px-4 py-2 rounded-lg hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300"
              >
                Logout
              </button>
            </>
            ...
            <>
              ...
              <Link
                to="/register"
                className="nav-button bg-gradient-to-r from-primary-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 font-medium"
              >
                Register
              </Link>
            </>
